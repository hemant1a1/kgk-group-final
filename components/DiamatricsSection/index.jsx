    ...
    <div className="relative pt-10 pb-6 md:pt-12 bg-white">
      <div className="container">
        <div className="px-0 lg:px-[50px] flex flex-col lg:flex-row items-center">
          ...
          >
            <Image src={about2} alt="about" className="w-full h-[360px] object-cover rounded-2xl" />
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="w-full lg:w-[50%] pl-0 lg:pl-20 pb-14 pr-0 xl:pr-14"
          >

            <p className="text-justify text-[15px] leading-[25px] mb-8 mt-6">
      ...
      <div className="relative w-full h-px bg-[#79869e] bottom-8 z-0"></div>
    </div>
  );
}
